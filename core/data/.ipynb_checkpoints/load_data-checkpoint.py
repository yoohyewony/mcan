...
class DataSet(Data.Dataset):
    def __init__(self, __C):
        ...
        #print(self.img_feat_path_list[0])
        

        # Loading question word list
        self.stat_ques_list = \
            json.load(open(__C.QUESTION_PATH['train'], 'r'))+ \
            json.load(open(__C.QUESTION_PATH['val'], 'r'))+ \
            json.load(open(__C.QUESTION_PATH['test'], 'r'))
        ...
        #print(self.qid_to_ques['199842002'])
        # -> {'image_id': 199842, 'coco_split': 'val2014', 'question': 'What number is on bus?', 'question_id': 199842002}
    ...
    def __getitem__(self, idx):
        ...
        if self.__C.RUN_MODE in ['train']:
            ...
            split = ques['coco_split']
            iid = split + '_' + str(ans['image_id'])    # image id
            ...
            split = ques['coco_split']
            iid = split + '_' + str(ques['image_id'])    # image id
